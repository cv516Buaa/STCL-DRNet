...
def _segm_resnet(name, backbone_name, num_classes, output_stride, pretrained_backbone, bn_freeze,with_meta):
    ...
    backbone = IntermediateLayerGetter(backbone, return_layers=return_layers,
                                       with_meta=with_meta, num_classes=num_classes)
...
def deeplabv3_resnet101(num_classes=21, output_stride=8, pretrained_backbone=True,
                        bn_freeze=False, with_meta=False):
    ...
    return _load_model('deeplabv3', 'resnet101', num_classes, output_stride=output_stride, 
                       pretrained_backbone=pretrained_backbone, bn_freeze=bn_freeze, with_meta=with_meta)
