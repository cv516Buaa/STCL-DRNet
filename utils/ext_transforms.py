...
class ExtToPILImage:
    ...
    def __call__(self, pic, lbl=None, sal=None):
        """
        Args:
        ...
        return F.to_pil_image(pic, self.mode), lbl, sal
...
class ExtRandomScale(object):
    ...
    def __call__(self, img, lbl, sal):
        ...
        return F.resize(img, target_size, self.interpolation), \
                ...
                F.resize(sal, target_size, InterpolationMode.NEAREST)
    def __repr__(self):
...
class ExtResize(object):
    ...
    def __call__(self, img, lbl, sal):
        ...
        return F.resize(img, self.size, self.interpolation), \
                ...
                F.resize(sal, self.size, InterpolationMode.NEAREST)
